...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : Editor
    {
        ...
        SerializedProperty m_RespawnAudioPlayerProp;
        ...
        readonly GUIContent m_RespawnAudioPlayerContent = new GUIContent("Respawn Audio Player");
        ...
        void OnEnable ()
        {
            ...
            m_RespawnAudioPlayerProp = serializedObject.FindProperty("respawnAudioPlayer");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_AudioSettingsFoldout)
            {
                ...
                EditorGUILayout.PropertyField(m_RespawnAudioPlayerProp,m_RespawnAudioPlayerContent);
            }
