using Assets._2DGamekit.Scripts.Audio;
...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public NestedRandomAudioPlayer rangedAttackAudioPlayer;
        public AudioSource respawnAudioPlayer;
